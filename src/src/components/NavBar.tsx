  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-6 md:gap-8 text-sm font-body">
        ...
        <a href="#projects" onClick={(e) => scrollTo(e, "projects")} className="text-muted-foreground hover:text-foreground transition-colors duration-300">
          {t.nav.projects}
        </a>
        <a href="#contact" onClick={(e) => scrollTo(e, "contact")} className="text-muted-foreground hover:text-foreground transition-colors duration-300">
          {t.nav.contact}
        </a>
        <button
